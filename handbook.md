...
## General Policies
#. Scope and Validity
    #. This document delineates the rules and regulations that govern the marshaling of combat in Atlantia.
    #. All combat and animal activities must be conducted according to the policies defined in this document.
        #. Combat Disciplines are Armored Combat, Combat Archery, Rapier Combat, Target Archery, and Thrown Weapons.
        #. Animal Disciplines are Equestrian Activities and Hounds.
        #. All activities under these categories must be supervised by a marshal warranted by the Atlantian Earl Marshal's Office to do so.
...
#. General Responsibilities
    ...
    #. The Marshals must enforce rules evenhandedly, regardless of the rank, affiliation, or degree of rudeness of the fighters involved.
    #. All Marshals must conduct themselves in a safe, courteous, and controlled fashion.
    #. In any contact discipline that includes projectile weapons, the Marshals must wear shatterproof sports or industrial high impact plastic eye protection.
...
#. The Structure of the Marshallate
    ...
    * Bottom Level:  (this includes all Apprentice Marshals (MIT) and Crowd Control Assistants (CCA, Line Marshals, etc.)
    ...
    #. The Types of Marshals and their Responsibilities
        #. Earl Marshal (EM, KEM)
            #. The Earl Marshal shall be responsible for the formulation, publication, and distribution of the rules of all activities and the marshal's policies.  The Earl Marshal may delegate to one or more deputies for this purpose, but the ultimate responsibility lies with the Earl Marshal.
            #. The Earl Marshal must conduct appropriate review of sanctions imposed by the Marshal In Charge of an Event (MIC).  The participants must be notified within five (5) business days of receiving of the report, or appeal, whichever arrived first.  The participants must be informed of the status of the investigation - closed and upheld, closed and overturned, or pending further investigation, with an explanation of the reason for delaying a decision.
            #. The Earl Marshal must submit required reports to the Society Earl Marshal.
            #. The Earl Marshal must meet the Marshal's mandate established in Kingdom Law and must meet the requirements of the Corporate Policy and those of the Society Earl Marshal.
            #. The Earl Marshal must appoint all Atlantian marshals but may designate Deputy Marshals to appoint Marshals in the Earl Marshal's place.
            #. The Earl Marshal must appoint Deputies for each Combat Discipline.
            #. The Earl Marshal must appoint an Emergency Successor to handle proper transition of the Earl Marshal office in case the Earl Marshal is no longer able to serve.
            #. The Earl Marshal will determine and publish the rules and regulations for experimental weapons and other experimental rules.
            #. The Earl Marshal is the arbiter for interpretation of all conventions or policies for all disciplines of combat.
            #. The Kingdom Marshal will impose sanctions upon those groups failing to comply with fighter practice waiver submissions policies, as appropriate, and will investigate repeated group sanctions for non-compliance with fighter practice waiver submissions policies, in collaboration with the Kingdom Seneschal.
        #. Deputy Earl Marshal for an Activity (DEM)
            #. The DEM must assist the Earl Marshal in creating and maintaining the conventions of the discipline, including:
                * Equipment standards
                * Authorization standards
                * Rules of Engagement
                * Scoring/Acknowledgement conventions
                * Safety Rules
            #. Conventions produced by a DEM must be approved by the Earl Marshal and published according to policy and/or law before taking effect.
            #. In the absence of the EM at an event, the DEM will be the final authority on the interpretation of conventions in their specific discipline.  In extreme cases, the DEM may overrule the MIC of an event, but only if they are not participating in the activity at the time of the dispute.
            #. The DEM may appoint assistants, but they will have no official standing within these policies.
        #. Deputy Kingdom Marshal for Training (DEM-T)
            #. The DEM-T will establish a training program that will maintain quality marshal's activities.
            #. The DEM-T may designate Deputy Marshals to carry out the training program across the Kingdom.
            #. The DEM-T will screen training program applicants. Those applicants accepted will become apprentice marshals.
        #. Knight's Marshal (KM)
            #. Any group that wishes to conduct any marshal related activity at an event must have a Warranted Marshal or sponsorship from a warranted Atlantian Marshal that will assume responsibility for the event. If the Marshal is unable to serve as Marshal in Charge for the event/activity (unable to attend the event, not warranted for the activity, or for some other reason) a warranted marshal must be recruited to serve as MiC.
            #. Each group will have at most one Knight's Marshal.
            #. The Knight's Marshal must ensure that practices are conducted in accordance with SCA corporate policy and the guidelines that are defined in this document and its appendices.  The Knight's Marshal must ensure that the group has a representative marshal present at such practices for all of the disciplines being practiced.  Any one marshal may represent any or all disciplines in which he or she is an authorized marshal.
            #. The Knight's Marshal should encourage the other marshals in their group to accumulate loaner equipment and do so themselves.
            #. The Knight's Marshal should encourage the marshals of each discipline in the group to become cross-trained in other disciplines and do so themselves.
            #. The Knight's Marshal must train new participants in the activities for which the Knight's Marshal is a warranted marshal.  The Knight's Marshal may delegate this responsibility to another marshal as long as that marshal is warranted in that particular discipline.
            #. The Knight's Marshal must ensure that there is a Marshal-In- Charge (MIC) for each local event that includes any marshal related activity.  In this process, the Knight's Marshal must work with the group's seneschal and the event's autocrat to select a mutually acceptable MIC.  The Knight's Marshal need not be the MIC.
            #. The Knight's Marshal shall ensure that the MIC for events hosted by their group files an event report.  A Knight's Marshal that fails in this obligation may be removed from office.
        #. Deputy Knight's Marshals (DKM)
            #. Marshals who have completed the specific training and testing program for a given discipline will become a warranted marshal in that discipline.
        ...
        #. Apprentice Marshals (also known as Marshals In Training (MITs))
            ...
            #. The apprenticeship program consists of the following:
                #. Apprentices must assist in marshalling at least four different events.
                #. The apprentice must get the prior approval of the Marshal in Charge for that event.
                #. At these events they will assist in all marshal functions.
                #. At least two of these events must be outside their local group.
                #. At least one of these events must be in a different region of the kingdom.
                #. At least one of these events must have significant melee combat.
            #. A warranted marshal must supervise all of the apprentices' activities.
            #. At the end of the combat activities, the apprentice must get written feedback from the Marshal in Charge.  This must be recorded on the apprenticeship form.
            #. After completing the apprenticeship program the apprentice shall send the completed form to the relevant discipline Deputy Earl Marshal.
            #. Completion of the apprenticeship program makes the apprentice eligible for a warrant, or warrant-eligible.
            #. Warrant-eligible apprentices may be warranted to a vacant knight marshal or deputy knight marshal position and then become warranted.
        #. Crowd Control Assistants (also known as "line marshals" (CCA))
            #. Crowd Control Assistants are only allowed at the discretion of the MIC-Event or the MIC of an Activity.
            #. Anyone may be a Crowd Control Assistant.
            #. The only activity of the Crowd Control Assistants is the warning of participants and spectators that they are approaching the boundaries of the combat activity.
            #. If the MIC deems that any CCA is dangerous, incompetent, or redundant, the MIC may remove the CCA from participation.
            #. Warranted marshals must take into account that Crowd Control Assistants may not be completely experienced in safety measures around a given activity and that they should be protected from dangerous situations.
        #. Responsibilities of all Marshals
            #. All marshals must attend an Atlantian Marshal's Seminar in their discipline once every three years. This could be their discipline meeting at Unevent or any marshal's training approved by the Earl Marshal or the appropriate discipline deputy.
            #. All marshals must be members of the SCA and receive The Acorn at their place of residence.
            #. All marshals must be completely familiar with the SCA Rules of the List, the SCA Marshal's Handbook, and this document.
    ...
    #. The Roles of the Marshal
        ...
        #. Marshal In Charge of an Event (MIC-Event) The MIC-Event is the marshal who is listed on the event registration form filed by the autocrat with the Kingdom Chronicler.  If the marshal listed on the event registration form is unable to fulfill this commitment, they must inform the autocrat and the group's Knight's Marshal as soon as possible.  A new MIC must be identified and the event registration form updated.
            ...
            #. MIC-Events must set scenarios, or delegate to a MIC- Discipline.  Note that the event's Autocrat defines the general nature of the scenario; however, all details of the execution of the scenarios are in the purview of the MIC-Event and MIC- Discipline.
            #. The MIC-Event must enforce all policies and conventions, and apply problem resolution as needed.
            #. The MIC-Event must withdraw sanction from any event where the MIC-Event is unable to halt unsafe or illegal activity.
            #. An MIC-Event must have:
                * A Marshal's Staff
            ...
            #. The MIC-Event may not participate in any marshal-related activities at the event outside the role of MIC-Event.
        #. Marshal In Charge of an Activity (MIC-Activity)
            #. Each marshal related activity conducted at an event must have a MIC-Activity.
            #. The MIC-Activity must be authorized to marshal that discipline.
            #. The MIC-Activity must deal with any problems during the discipline activity.  All problems rated significant or severe must be reported to the MIC-Event.
            #. The MIC-Activity has the specific right to remove any participant from the Activity.  This is to be treated as a severe problem and reported accordingly.
            #. The MIC-Activity must conduct, or assign subordinate marshals to conduct, an inspection of the armor and weapons that will be used by all combatants prior to starting combat activities.
            #. Before each activity, the MIC-Activity must ask the combatants if they have had their equipment inspected.  If any equipment has not been inspected the participant must complete the inspection process before starting the activity.
            #. The MIC-Activity must attempt a quick visual inspection of all equipment before commencing the activity.  This is not always possible, and does not take the place of proper inspection procedures, or the responsibility of the user to maintain equipment in a compliant status.
        #. Marshals assisting MIC-Activity
            #. These Marshals must be warranted in the discipline over which they are officiating.
    #. (Deleted and reserved for future policies)
    #. Participants and Their Responsibilities
        #. Definition: All individuals who wish to participate in a marshaled combat discipline in Atlantia must either:
            #. Have a permanent address within the borders of the Kingdom of Atlantia where the participant receives their Kingdom newsletter and is authorized by the procedures outlined in this document.
            #. Be resident in a foreign Kingdom as defined by Corpora and properly authorized by the Marshals of that Kingdom.  Visiting fighters must review with the MIC the Policies and Conventions that apply to the discipline in which they wish to participate.
        #. Combat Participant Responsibilities
            #. All participants must know and follow the current rules.
            #. All participants must report to the Minister of Lists and either show proof of waiver on file with the Office of the Registry or execute a waiver.
            #. The Marshals assume that all participants believe they are acting in a safe and courteous conduct at all times.  It is the participant's responsibility to demonstrate this by his or her actions before, during, and after the activity.
            #. All participants are responsible for conducting themselves in a controlled, courteous, and safe fashion at all times, and must accept the criteria of the Marshals for these characteristics.
            #. Participants at events may only participate in activities that they are correctly authorized in, with the exception of authorizing activities.
            #. At official practices, participants must either show proof of a waiver on file with the Office of the Registry or complete a waiver of liability and submit it to the MIC of the practice.
            #. All participants must have all equipment that they plan to use that day inspected by a Marshal for the activity or the designated Inspecting Marshal (if there is one) before participating in that activity.
            #. If the participant has a grievance, resolution will be conducted immediately after the activity by the MIC of that activity, and can be appealed to the MIC-Event by the aggrieved individual.
            #. The participant must give truthful information in cases where reports must be made.  Falsification of information may result in termination of all authorizations or other sanctions.
            #. All participants, regardless of office or rank, must obey the directions of the Marshals while involved in a marshaled activity.  (NOTE:  This applies to marshals as well.)
    #. Dishonorable Behavior
        #. It is understood by the Marshals that all but a tiny fraction of participants in the marshaled activities participate in a spirit of honor, dignity, and chivalry.  However, even with the best intent, participants may behave in a manner contrary to that spirit.  It is the Marshal's responsibility to bring any such behavior to the participant's attention in such a fashion to indicate the above message.  Repeated behavior of unsportsmanlike nature will result in sanction at the Marshal's discretion.  Such unacceptable behaviors will include, but not be limited to:
    ...
    #. Warrants
        ...
        #. Warrants will be kept by roster by the Earl Marshal.
        #. For Knight's Marshals, warrants will remain in effect for 2 years from the date of issue, unless the warrant is suspended or removed by the Earl Marshal, or another warrant is issued for that position.
        #. Deputy Knight's Marshal warrants expire upon resignation or termination by the Earl Marshal.
        #. Kingdom Deputy Marshals serve at the pleasure of the Earl Marshal.
        #. The Earl Marshal must annually audit the roster, and any individual no longer meeting the required attributes of a Marshal will have his or her warrant terminated.  The KEM must submit the roster of Marshals to the Crown once per reign.  This will usually happen at Curia Regis, or at Coronation on request of the incoming Crown.
    #. Reporting
        #. Event Reports An event report must be filed by the MIC-Event within 7 days of each event (except where required to file a special report earlier due to problem resolution) and must include the following information.  Event reports must be filed in writing and must include any supporting documentation as necessary.
            #. The name of the Marshal in Charge of the Event submitting the report, and the Minister of the Lists.
            #. The name of all marshals (incl. apprentices) and the capacity in which they served.
            #. A list of all authorization attempts including weapon form and result.
            #. A description of marshal activities for the day, including disciplines represented and scenarios enacted, with an evaluation of the activities for success and safety.
            #. A description of any injuries requiring professional medical services.  This is in addition to the requirement for notifying the KEM within 24 hours.
        ...
        #. Deadlines
            #. If a report is not turned in by the deadline, the marshal will be placed on suspension for a period of not less than 90 days, during which time s/he may not perform any marshal activities including (but not limited to):
                * Authorizations
                * Armor and weapon inspections
                * Marshaling a fight
                * Marshaling a practice
                * Serving as MIC of any event
            #. Following a second offense, the marshal's warrant will be revoked for a minimum of one year.
            #. Failure to report may negate any sanctions or authorizations at the discretion of the Earl Marshal.
...
#. MIC Responsibilities and Powers The MIC-Event must assess any problems for immediate action.
    #. The MIC must immediately record, on paper, all significant or severe problems and include them in the event report.
    #. In the case of severe or continuing problems, the MIC may remove the participant from further participation in any activity for the remainder of the event.
    #. If the MIC feels that the participant represents an ongoing problem or danger s/he must suspend the authorization of the participant.
#. Suspension The suspension of any one Authorization by the MIC-Event will also be a suspension of a participant's authorization in all disciplines until resolution by the Earl Marshal.
    #. The MIC-Event will physically take possession of the participant's authorization card.
    #. If the combatant does not cooperate that is an additional violation.
    #. The MIC must complete the event report immediately after the event.
    #. The MIC must contact the Earl Marshal by email or telephone within two days of the end of the last activity of an event.
    #. The MIC must send copies of the event report to both the Earl Marshal and Minister of Lists.
    #. Suspensions last until lifted or replaced by the Earl Marshal.
#. Review and Investigation
    #. The Earl Marshal will begin a review of any authorization suspension immediately upon receipt of the report.
        #. The Earl Marshal may lift the authorization suspension.
        #. The suspension may be left in place during further consideration.
#. The Earl Marshal may designate an investigator for serious rules violations.
    #. The investigator will gather information and make recommendations.
    #. This initial investigation must take less than 15 days.
    #. After reviewing the investigator's recommendations the Earl Marshal will take any action at his/her sole discretion, including dropping the matter.
#. Marshal's Court For the resolution of serious problems, the Earl Marshal may either convene a Marshal's Court or begin a summary problem resolution (see below).
    #. The Earl Marshal may not unilaterally levy sanctions more severe than suspension without such sanctions being recommended by a Marshal's Court.
    #. The Marshal's Court will consist of three to five marshals and may not include the Earl Marshal.
    #. The Marshal's Court shall determine their deliberative process with due regard to Fairness.
    #. The sanctions imposed by a Marshal's Court may include, but are not limited to, the following sanctions:
...
#. Summary Problem Resolution
    ...
    #. Fixed summary resolution results from an agreement between the Earl Marshal and the subject specifying the violations and the sanctions.  The fixed summary resolution must be specified in writing and signed by both the Earl Marshal and the subject.  There are no limitations on the terms of this problem resolution.
    #. Once the subject and the Earl Marshal agree to either an open ended or fixed summary resolution, any Marshal's Court shall be terminated.
#. External Problems
    #. Marshals at all levels may have to deal with problems beyond the combatants and the Marshals.
...
#. Complaints and Appeals
    #. Complaints or grievances by marshals or participants must be submitted in writing within 15 days of the last activity of an event using an incident report form such as that furnished in the Reports Appendix or the Marshals Web Page.
    #. Participants' appeals of sanctions must be made in writing, postmarked within 15 days of the MIC-Events sanction.
...
#. Armored Combat Authorization Procedures
    ...
    #. The authorization process ensures that all fighters taking the field are conducting themselves according to a common standard.
    #. This process also ensures the minimal level of proficiency necessary to ensure that they do not present a threat to themselves or anyone else on the field.
    #. All combatants in tournaments and melees in Atlantia must be authorized in the weapons they wish to use.
    #. Visitors to Atlantia may participate at Atlantian events if they go over the Atlantian rules with an Atlantian marshal before they compete.
...
#. Who May Become Authorized
    #. To become authorized a fighter must meet the following requirements.
...
#. Where Can Someone Go Through the Authorization Procedure
    #. All armored combat authorizations will be held either at an SCA event or at fighter's practice.
    #. Marshals wishing to conduct authorizations at practice must obtain prior permission to do so from the Deputy Earl Marshal for Armored Combat, and coordinate MOL support to insure all reporting standards, both for MICs and for MOLs, are adhered to.
#. When Can Authorization Occur
    #. Authorizations can be held at any time during the course of the event. When a combatant authorizes during an event they may participate in subsequent activities as allowed by their new authorization.
#. Marshals
    #. At least one of the marshals must live in a different local group from the candidate.  If the candidate lives in a barony, at least one of the marshals must live outside that barony.
    #. At least one marshal MUST be authorized in the applicable weapons form.
    #. Inspect the armor and equipment of all personnel participating in the authorization process.
    #. Test the knowledge of the candidate regarding the applicable rules governing combat in Atlantia.
    #. The knowledge test should include questions applicable to the weapons being used in the authorization.
...
#. Authorization for Minors
    ...
    #. The local marshal will arrange for at least one of the parents or legal guardians to observe the fighting practice.  Every attempt should be made to ensure that the parents leave with a familiarity with SCA fighting.
    #. The minor must attend at least one fighting event before the event at which the minor attempts to authorize.
    #. The parents or legal guardians shall be asked to come to an event before authorization.
    #. A standard authorization will be conducted with at least one of the officiating marshals being the Earl Marshal or designated Deputy Earl Marshal.
...
#. Appearance on the List Field.
    ...
    #. For specifics and examples of this requirement, please refer to [http://marshal.atlantia.sca.org](http://marshal.atlantia.sca.org/).
...
#. Conventions of Combat for Armored Combat
    #. Target Areas.
        #. Torso: All of the torso above the point of the hips including the shoulder blades and the area between the neck and shoulder will be considered part of the torso.
        #. Face: The area between the collarbones and the mid brow and between the side burns.
        #. Head: The whole head and the neck except the face (as defined above).
        #. Hips: Begin with a line even with the bottom of the groin up to the point of the hip.
        #. Thighs: The leg from one inch above the top of the knee up to a line even with the bottom of the groin.
    ...
    #. Targeting.
        #. Blows landed outside the target areas need not be counted.
        #. A fighter may not intentionally strike areas outside the target areas.
        #. A fighter may not intentionally strike with the non-striking surface of a weapon (haft, hilt, etc.).
    #. Telling Blows.
        #. A blow that strikes a legal target area with telling force will be acknowledged.
        #. Telling force is determined by evaluating the blow against the SCA standard of fully armored.
        ...
        #. The exact force level necessary to meet this standard is determined by each fighter but must be within the normal range defined by all Atlantian fighters.
        #. Missile weapons must strike the same targets as thrusting weapons. But, any contact from a projectile is considered a telling blow.
        #. Blows striking a weapon or shield before striking a target will be considered a telling blow if the force of the blow after striking the intervening shield or weapon is sufficient to be a telling blow.
        #. Blows in which the weapon is dropped upon impact may be discounted.
        #. Blows in which a weapon strikes a combatant because it physically breaks upon striking the shield or defensive weapon need not be counted.
        #. Blows struck with the non-striking portion of the weapons shall not be counted (haft, hilt, etc.).
    #. Results of Telling Blows.
        #. Telling blows to the face, head, or torso are considered killing.
        #. Telling blows from a swung mace, great sword, or pole arm to the hip or shoulder are killing.
        #. All other blows are wounding blows.
        #. Projectiles have the same effect as thrusts.
        #. Thrusts to the head, outside of the face, are not telling blows and need not be counted.
    #. Death.
        #. After receiving a killing blow the fighter will cease throwing blows.
        #. After receiving a killing blow the fighter will fall to the ground or in some other way clearly indicate he has been defeated.
        #. In single combat the bout is ended after a killing blow (except double kills).
        #. When both fighters, in a one-on-one bout, are killed, they either fight the bout over starting from mutually unwounded conditions or, both take the bout as a loss, depending on the scenario.
    #. Wounds.
        #. Wounding blows to the shoulder or arm will cause the loss of the use of that arm.
        #. The wounded arm may not be used to block or throw blows.
        #. A second telling blow to that arm or shoulder will be a killing blow.
        #. Wounding blows to a thigh or hip will cause the fighter to fight from his knees.
        #. The fighter must keep one knee on the ground unless he hops.
        #. Hopping is allowed if the fighter puts no weight on the wounded limb.
        #. Hopping is frequently used to throw one blow after being dealt a wounding blow.
        #. This must be done without putting any weight on the wounded limb.
    #. Interruptions.
        #. Any blow started before any interruption of combat (such as death or a hold) will count as if they landed before the interruption.
    #. Starting Combat.
        #. Combat will be started when the marshals call lay-on.
        #. Except special scenarios fighters should start fights well out of range.
    #. Holds.
        #. Effect of a Hold
            #. All combatants must immediately cease throwing blows.
            #. They must stop moving about the field.
            #. Fighters should not drop their guard until all fighters have stopped throwing blows.
            #. Combatants may call Hold when any unsafe situation develops.  For example, a fighter should call hold if his helm comes off.
        #. Calling a Hold
            #. In single combat, hold will be called when a fighter is not capable of defense. In single combat, defenseless is defined as having no weapons in hand.
            #. If a fighter falls, or if any portion of a hand, arm, or a part of the upper torso or head touches the ground the fighter is considered defenseless.  A fighter who feels that he is not defenseless in any of the above conditions may ask the marshals not to call hold in a specific circumstance.  If the marshal feels that the request would not create a dangerous situation he will not call hold in the specified situation.
    #. Use of Weapons.
        #. All weapons to be used in a particular bout of single combat will be declared to the opponent and the marshal before the fight.
        #. If an auxiliary weapon is carried in such a way as to prevent proper acknowledgment of a blow, any blow striking the weapon will be considered a telling blow to the area that would have been hit.
        #. Except for the proper use of a weapon, grasping, pushing, or striking an opponent is not allowed.
        #. Striking, pushing, or pressing an opponent's shield with a hand, weapon, or shield is allowed.
        #. If the opponent has an edged weapon, striking, pushing, or pressing an opponent's weapon's striking portion (regardless of the orientation of the edge) with any part of the body (for example grabbing a sword with the hand) is not allowed.
        #. Weapon strikes with excessive force are not allowed. Blows with force levels that significantly exceed that necessary to be a telling blow, and significantly increase the chance of substantial injury are blows with excessive force.
    #. Helms.
        #. If a fighter's helm comes off or their visor opens during combat, the fight will be stopped and combatant declared dead.  The combatant may not fight again until some steps have been taken to prevent a recurrence of the problem.  A marshal will inspect the helm before it is used again.
    #. Engagement. These rules apply to melee combat only. In one on one combat fighters are always considered to be engaged.
        #. A fighter may only attack opponents they are engaged with.
        #. To engage an opponent a fighter must establish eye contact and be in front of the opponent.
        #. A fighter may not attack an opponent that cannot see them.
        #. All fighters must attempt to engage all fighters who are attempting to engage them.  The simplest way to meet this requirement is to back up until all those attempting to engage are in front of the fighter they are trying to engage.
        #. If a combatant is engaged and then turns their back, or if they are charging past an opponent, the opponent may throw one blow immediately after the combatant turns away.
    ...
    #. Melees. Individual battles may have their own particular rules and conventions besides those stated in this document as long as those rules do not conflict with any of the rules governing combat.
        ...
        #. A hold will not be called for fighters who lose their weapon in melee.
#. Conventions of Combat for Combat Archery
    #. The legal target area for projectile weapons shall be same as any thrusting weapon that is legal in a given scenario.  Exception: At the discretion of the MIC, projectile strikes to the face may be made legal, even in scenarios where face thrusts are prohibited.
    #. Archers shall not fire at a combatant if the arrow/bolt cannot leave the bow before contact with the target. For rapier combat, crossbows and handbows shall not fire at a combatant at a range of less than 15 feet.
    #. On the cry of hold or when slain, all arrows will be unnocked, and crossbows will be uncocked.
    ...
    #. For rapier combat, rapier conventions of combat are to be used. In addition, maximum draw weight for crossbows in rapier will be 550 inch/pounds.
...
#. Marshal Responsibility. Marshals for Youth Combat exist within the structure established under the Crown and Earl Marshal of Atlantia.  All marshals for Youth Combat activities are warranted, have authority and are expected to conduct themselves as warranted marshals of this Kingdom, according to Kingdom Law and the Policies of the Earl Marshal.
    ...
    #. All Youth Combat Marshals are required to complete the Youth Marshal Apprentice Program (also known as Marshals in Training (MiTs))
        #. Apprentices are required to take the Youth Combat 101 class prior to assisting in marshalling
        #. Apprentices must assist in marshalling at least four events
        #. The apprentice must get prior approval of the Youth Marshal In Charge for that event
        #. At least one of these events must be outside their local group.
...
#. General
    #. Youths participants must be at least 6, but less than 18 years old to participate in Atlantian Youth Rapier.
    #. A warranted Youth Rapier Marshal and at least one additional unrelated adult must be actively managing all youth rapier activities, including training, sparring, and combat.
    #. Youth participants must have a Youth Rapier Authorization to participate in tournaments. See Authorization and Training for more information.
    #. To participate in any aspect of youth rapier, a youth must:
        #. Show a blue SCA membership card OR
        #. The Youth's Responsible Adult, per Youth Combat section, may sign a Minors Consent to Participate Form for the youth for each event or practice.
    #. To participate in training, practice or in tournament a youth must have their Responsible Adult, per Youth Combat section, present.
    #. All youth rapier combat must follow participation policies set forth in Youth Combat section.
...
#. Authorizations
    ...
    #. Youths may only participate in tournaments or melees with those from the same division.
    #. Youths may only participate in melees with a Division 3 authorization.
    #. Youths and their Responsible Adult, per Youth Combat section, must attend the youth rapier fighter class prior to their first authorization.
    #. Any youth authorized in adult rapier may not hold a youth rapier authorization.
    #. Youth Rapier Marshals must witness the authorization and work with the MOL to ensure the required paperwork is complete paperwork.
        #. Authorizations are done per age group and weapon type.
        #. Authorizations shall be conducted in a manner appropriate for the division.
    #. A Responsible Adult, per Youth Combat section, must be present for their child's authorization.
    #. All youth combatants must reauthorize when changing divisions.  Youths are expected to practice at the next division before authorizing.
    #. A combatant with a valid authorization may continue to participate in their current division if they fail an authorization for the next division.
#. Conventions of Combat
    #. Youth rapier follows the rapier conventions of combat for Atlantia with the following modifications:
        #. Youth rapier will not be conducted on the same field at the same time as any other activities.
#. Rules of the List
...
#. Marshaling
    ...
    #. Youth Rapier Marshals
        #. The Kingdom Youth Rapier Marshal will be responsible for issuing Youth Rapier Marshal warrants.
        #. Requirements to become a Youth Rapier Marshal
    #. In addition to completing the Apprentice Marshal process for Youth Rapier, youth rapier marshals must do the following:
        #. Maintain an active Rapier Marshal warrant
        #. Maintain an active SCA background check
        #. Take the Youth Rapier Marshal 101 class at least once every three years.
    #. In addition to normal marshal responsibilities, youth rapier marshals are responsible for the following:
        #. Teach the pre-authorization class to potential parents and youth combatants.
        #. Perform authorizations in all divisions
        #. Perform inspections prior to combat, in the presence of the parent or legal guardian of the combatant.
        #. Take an active role in combat management, sportsmanship, and assistance with blow calling.
#. Responsibilities of Parents/ Legal Guardians
    #. Parents/legal guardians are to understand this is a contact sport and that injuries may occur.
    #. The responsible adult is to behave in a courteous and responsible manner at all times.
    #. The parents/legal guardians are urged to become an warranted Youth Rapier Marshal so that they can work closely with their child in this activity.
    #. The parents/legal guardians are responsible for their child's safety, with the Youth Rapier Marshals guiding the armoring/safety process.
    #. The parents/legal guardians are required to read and understand these rules and standards and are to make sure that their child follows them.

## Target Archery

#. Atlantia uses the Society Target Archery Rules, found at: [http://www.sca.org](http://www.sca.org/) with the following changes & clarifications:
#. Equipment Standards
    ...
    #. Crossbows with a modern pistol grip, modern rifle or air-rifle-style stock are not allowed.
    #. Bow quivers (ones that attach to the bow or crossbow) are not allowed.
#. Procedure & Marshalling Standards
    #. Equipment Inspection
        #. At all SCA activities, bows & ammo must be inspected by the marshal in charge or their designee before being used.
        #. Hand bows should be brought to the marshal unstrung. Crossbows can be left strung.
        #. At an event with 20 or more archers, stickers shall be used to mark bows that have been inspected.
        #. Marshals shall not inspect their own equipment, unless they are the only marshal present.
    #. Safety Zones
        #. Safety zones need to be clearly marked off. However, visually obvious safety zones (such as a field full of targets with ample space between them), are allowable.
        ...
        #. Physical barriers such as a hill, permanent solid backstop, a wall, etc can be used to reduce the amount of safety zone needed. However, the barrier must completely cover the safety zone in order to count. A small barrier that could be shot around is not sufficient.
        #. Archery netting can not be used to reduce safety ranges, but is encouraged to help archers recover missed arrows.
    #. Bows & Crossbows may not be carried downrange.
    #. A marshal may shoot while marshalling upon their own discretion based upon the current situation.
    #. The Atlantian Royal Round is used as the official ranking system of Atlantian archers. Specific rules on running this shoot, and recording the scores, are found at the Kingdom Archery website: http://archery.atlantia.sca.org/
    #. An archery marshal from each local group must send reports quarterly about the state of archery within their group, and after each event to the Deputy Kingdom Earl Marshal for Target Archery.
#. Traditional Rulings. Archery has a long tradition in Atlantia. Many standards have developed that archers are used to obeying. When these standards are changed without warning, situations may occur. Therefore, the following rulings shall be considered always in effect, UNLESS the marshal running the particular shoot specifies otherwise. Marshals are encouraged, but not required, to publish any changes to these rulings in advance.
    ...
    #. Firing more than one shaft at a time is allowed. Archers must demonstrate competency in this technique to the marshal prior to performing it.

## Thrown Weapons

#. Thrown Weapon regulations are per the Society regulations, which can be found at [http://www.sca.org](http://www.sca.org/).
...
#. Rapier Authorization Procedures
    #. Authorizations will be conducted under the following conditions:
        #. All authorizations will be held at an SCA event or at an SCA fighter practice.
            ...
            #. Marshals shall ensure that an MOL is present to support the authorization.
        #. A two-marshal team will run the authorization and shall satisfy the following requirements:
            #. At least one of the marshals must live in a different local group from the candidate.  If the candidate lives in a barony, at least one of the marshals must live outside that barony.
            #. Neither the marshals nor the usher may be fighters who regularly practice with the candidate.
            #. Both marshals shall be authorized in the form being attempted.
    ...
    #. Fighters from other kingdoms shall participate as follows:
...
#. Rules of the List for Rapier Combat
    ...
    #. All rapier combat is done in the round, not strip-style in a line.
